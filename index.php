...
<script data-ad-client="ca-pub-1033335667627605" async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
<link href="https://assets.calendly.com/assets/external/widget.css" rel="stylesheet">
<script src="https://assets.calendly.com/assets/external/widget.js" type="text/javascript" async></script>

<style>
/* Base Style Refinement for Blank White Part */
body {
...
.section-radial-bg::before {
    ...
    max-width: 1200px;
    height: 700px;
    background: radial-gradient(circle at 50% 0%, rgba(23, 187, 125, 0.08), transparent 60%);
    pointer-events: none;
    z-index: -1;
}
...
.feature-card {
    ...
    box-shadow: 0 4px 12px rgba(2, 114, 167, 0.05); 
    padding: 32px 24px;
    flex: 1 1 30%;
    max-width: 32%;
    min-width: 280px;
...
.feature-card:hover {
    ...
    box-shadow: 0 10px 25px rgba(2, 114, 167, 0.1);
}
...
/* HIGHLIGHTED CARD STYLING (Dark Blue) */
.feature-card-highlighted {
    background-color: #0f172a; /* Dark Navy/Blue */
    border: 1px solid #17bb7d; /* Accent Green Border */
    box-shadow: 0 10px 30px rgba(23, 187, 125, 0.15);
    transform: scale(1.05); /* Make it pop slightly larger */
    z-index: 10;
}
...
.badge-popular {
    ...
    left: 50%;
    transform: translateX(-50%);
    background: linear-gradient(135deg, #2ed99a, #17bb7d);
    color: #ffffff;
    padding: 4px 16px;
    border-radius: 20px;
    font-size: 11px;
    ...
    letter-spacing: 1px;
    box-shadow: 0 4px 10px rgba(23, 187, 125, 0.3);
    white-space: nowrap;
}

/* Highlighted Gradient Button */
.btn-highlighted {
    background: linear-gradient(135deg, #2ed99a, #17bb7d) !important;
    color: #ffffff !important;
    border: none !important;
}
.btn-highlighted:hover {
    box-shadow: 0 4px 15px rgba(23, 187, 125, 0.4);
    color: #ffffff !important;
...
<body>
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-NCPZ4D8"
        ...
        <div class="modern-hero">
            <div class="hero-grid">
                <div class="hero-content">
                    <div style="display:inline-flex; align-items:center; background: rgba(255,255,255,0.1); padding: 6px 16px; border-radius: 50px; margin-bottom: 24px;">
                        <i class="fa fa-shield-alt" style="color: var(--color-brand-green); margin-right: 8px;"></i>
                        <span style="color: #cbd5e1; font-size: 14px;">Trusted by 200+ enterprises across India</span>
                    </div>
...
<div class="fusion-sep-clear"></div>
    ...
    <div class="fusion-separator fusion-full-width-sep sep-single" style="border-color:#020202;margin-top:-32px;margin-bottom:-1px;">
    <span class="icon-wrapper" style="border-color:#020202;"><i class="fa fa-thumbs-up" style="color:#020202;"></i></span></div><div class="fusion-fullwidth fullwidth-box" style="background-color:#f2f2f2;background-attachment:fixed;background-position:left top;background-repeat:no-repeat;-webkit-background-size:cover;
        ...
        <div class="avada-row">
            ...
            <div class="features-grid" style="margin-bottom: 50px;">
                <div class="feature-card">
                    ...
                    <h3>3S — Safety Support System</h3>
                    <p>Track testing, calibration, and expiry of fire extinguishers, hydrants, leak sensors and more — never miss a renewal again.</p>
                ...
                <div class="feature-card">
                    ...
                    <h3>SEnSE_L</h3>
                    <p>All HSE Acts, Rules and Notifications hyperlinked in plain English — your living legal library.</p>
                    <a href="sense.php" class="card-read-more">Learn More &rarr;</a>
                </div>
            </div>
            ...
            <div class="features-grid">
                <div class="feature-card">
                    ...
                    <p>India's pioneer in Responsible Care consultancy — embed sustainability into every operation.</p>
                ...
                <div class="feature-card">
                    ...
                    <p>Take the help of experts ranging from Safety to Taxation, Labour to Environmental statutes to track your compliance.</p>
                    <a href="legalassessment.php" class="card-read-more">Learn more &rarr;</a>
                </div>
            </div>
...
<div class="fusion-sep-clear"></div>
<div class="fusion-separator fusion-full-width-sep sep-single" style="border-color:#020202;margin-top:-1px;">
<span class="icon-wrapper" style="border-color:#020202;"><i class="fa fa-chevron-down" style="color:#020202;"></i>
</span>
</div>
