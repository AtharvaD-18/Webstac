...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is an HSE audit?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "An HSE (Health, Safety, Environment) audit evaluates an organization's safety practices against a checklist based on its manufacturing activities and globally accepted benchmarks. Since audit quality depends heavily on the auditor's experience, it is considered more of an art than a science."
      }
    },
    {
      "@type": "Question",
      "name": "Who provides HSE audit software and consultancy in India?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Webstac Software Pvt Ltd has been in the HSE audit business since 2003, offering HSE audit software with an internationally known partner to benchmark and improve safety culture. Webstac's clients include Reliance, Tata Power, BASF, Hikal, Sudarshan, Lanxess, and Clariant."
      }
    },
    {
      "@type": "Question",
      "name": "What makes Webstac's HSE audit expertise credible?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Webstac's MD, Mr. Bukkawar, is one of the authors of the Guidance Manual of Responsible Care for India and worked with the Indian Chemical Council on Responsible Care for more than a decade."
      }
    }
  ]
}
...
<li  id="sticky-menu-item"  class="menu-item menu-item-type-post_type menu-item-object-page menu-item"><a href="contactus.php" style="color:#0272A7;text-decoration:none;font-weight:bold;font-size:13px;">Contact Us</a></li>
		...
		<div class="page-title">
			<div class="page-title-wrapper">
				<div class="page-title-captions">
											<h1 class="entry-title">HSE Audit and Improvement in Safety Culture</h1>
																				</div>
	...
	<div class="modern-card" style="flex:1; min-width:55%; box-sizing: border-box;">
		...
		<p><span style="color: #000000;">
		Our clients range right from Reliance to Tata Power. We are doing it even before it was a legal requirement.
		</span></p>
		<p><span style="color: #000000;">
		...
		<p><span style="color: #000000;">
		Our recent client list extends to  
		</span></p>
		<ul>
		<li><strong><span style="color: #013953;">Reliance </span></strong></li>
		...
		<li><strong><span style="color: #013953;">Tata Power</span></strong></li>
		<li><strong><span style="color: #013953;">BASF</span></strong></li>
	...
	<!-- Image Column -->
	<div style="flex:0 0 35%; min-width:300px; position:sticky; top:28px;">
