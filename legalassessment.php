...
<li  id="sticky-menu-item"  class="menu-item menu-item-type-post_type menu-item-object-page menu-item"><a href="contactus.php" style="color:#0272A7;text-decoration:none;font-weight:bold;font-size:13px;">Contact Us</a></li>
		...
		<div class="page-title">
			<div class="page-title-wrapper">
				<div class="page-title-captions">
											<h1 class="entry-title">Legal Assessment</h1>
																				</div>
	...
	<div class="modern-card" style="flex:1; min-width:55%; box-sizing: border-box;">
		...
		It is now legal requirement of the amended Companies Act (2013) to provide a 
		system for legal compliance and carry out an assessment of all compliances. 
		</span></p>
		<p><span style="color: #000000;">
	...
	<p><span style="color: #000000;">
		...
		<ul>
		<li><strong><span style="color: #013953;">Labour Laws </span></strong></li>
		<li><strong><span style="color: #013953;">Company’s Act</span></strong></li>
		<li><strong><span style="color: #013953;">Taxation</span></strong></li>
		<li><strong><span style="color: #013953;">Import & Export</span></strong></li>
