...
<body class="page page-id-10883 page-template-default no-mobile-slidingbar no-mobile-totop mobile-logo-pos-left layout-wide-mode mobile-menu-design-modern" data-spy="scroll">
...
<li  id="sticky-menu-item"  class="menu-item menu-item-type-post_type menu-item-object-page menu-item fusion-dropdown-submenu"  ><a href="Responsiblecareglimpses.php" style="color:#0272A7;text-decoration:none;font-weight:bold;font-size:13px;">Responsible Care</a></li>
	...
	<div id="sliders-container">
			...
			<div class="page-title-container page-title-container-breadcrumbs page-title-left" style="background-image: url('https://images.unsplash.com/photo-1589829085413-56de8ae18c73?auto=format&fit=crop&w=1920&q=80');">
		<div class="page-title">
			<div class="page-title-wrapper">
				<div class="page-title-captions">
											<h1 class="entry-title">SEnSE(Safety and Environment Super Encyclopaedia) Legal.</h1>
																				</div>
				<ul class="breadcrumbs"><li> <a href="index.php">Home</a></li><li>SEnSE_L</li></ul>			</div>
		</div>
	</div>
	...
	<div class="modern-card" style="float:left; width:60%; box-sizing: border-box;">
		...
		<li><strong><span style="color: #013953;">Search –  Key in  word/s and it  shows the relevant Acts, Sections, Rules, Sub-Rules, Commentary, FAQ, etc., .</span></strong></li>
		<li><strong><span style="color: #013953;">HSE update –  Informs and updates on current issues in HSE across the world .</span></strong></li>
		<li><strong><span style="color: #013953;">Amendments – On HSE legislations across India.</span></strong></li>
		<li><strong><span style="color: #013953;">Case laws – Major Cases decided by High Court and Supreme court on all important HSE Legislations</span></strong></li>
		</ul>
		<br>
		<br>
		...
		<p></p>
		<ul>
		<li><strong><span style="color: #013953;">Mr. V. G. Bukkawar, Retired Joint Director, Directorate of Industrial Safety & Health, Government of Maharashtra and Adviser, Indian Chemical Council.</span></strong></li>
		<li><strong><span style="color: #013953;">Mr. A N Biswas, Retired Additional Chief Controller of Explosives.</span></strong></li>
		<li><strong><span style="color: #013953;">Mr. Ram Pethe, Retired Senior Environment Engineer, Maharashtra Pollution Control Board.</span></strong></li>
		<li><strong><span style="color: #013953;">Mr. Ashok Jain, Retired Senior Law officer, Maharashtra Pollution Control Board.</span></strong></li>
		</ul>
	</div>
...
<aside style='padding:0 0 0 30px' class="sidebar sidebar-primary widget-area" role="complementary" aria-label="Primary Sidebar" itemscope="" >
	<section>
			...
			class="button" href="images/SenSE.pdf">Download Brochure</a>
			</li>
			<li style='margin:30px 20px 30px 20px'><img src="images/SenSE.jpg" width="300"></li>
...
<aside style='padding:0 0 0 30px;background-color: white;' class="sidebar sidebar-primary widget-area" role="complementary" aria-label="Primary Sidebar" itemscope="" >
<section>
				
			<ul style='list-style:none'>
			
			<li style='margin:0px'>
			<a style='color:#686868;font-size:20px;font-weight:bold' 
			class="button" >DOWNLOAD APP FOR</a>
			</li>
			<li style='margin:30px 20px 30px 20px'>
			<a  
			class="button" href="https://play.google.com/store/apps/details?id=in.webstac.webstac"  target="_blank">
			<img src="images/googleplay.png" width="300"></a>
			</li>
