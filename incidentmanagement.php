...
<div class="sticky-shadow">
	<div class="avada-row">
		...
		<ul class="navigation menu fusion-navbar-nav">
					<li  id="sticky-menu-item"  class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item current_page_item menu-item"  ><a href="index.php" style="color:#0272A7;text-decoration:none;font-weight:bold;font-size:13px;">Home</a></li>
<li  id="sticky-menu-item"  class="menu-item menu-item-type-post_type menu-item-object-page menu-item"  ><a href="about.php" style="color:#0272A7;text-decoration:none;font-weight:bold;font-size:13px;">About Us</a></li>
<li  id="sticky-menu-item"  class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item fusion-dropdown-menu"  ><a style="color:#0272A7;text-decoration:none;font-weight:bold;font-size:13px;">Packages <span class="caret"></span></a>
<ul class="sub-menu">
...
<li  id="sticky-menu-item"  class="menu-item menu-item-type-post_type menu-item-object-page menu-item"><a href="contactus.php" style="color:#0272A7;text-decoration:none;font-weight:bold;font-size:13px;">Contact Us</a></li>
	...
	<div id="sliders-container">
			...
			<div class="page-title-container page-title-container-breadcrumbs page-title-left" style="background-image: url('https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?auto=format&fit=crop&w=1920&q=80');">
		<div class="page-title">
			<div class="page-title-wrapper">
				<div class="page-title-captions">
											<h1 class="entry-title">Infoinci(Information Management of Incidents)</h1>
																				</div>
				<ul class="breadcrumbs"><li> <a href="index.php">Home</a></li><li>Infoinci</li></ul>			</div>
		</div>
	</div>
	...
	<div class="modern-card" style="float:left; width:60%; box-sizing: border-box;">
		...
		INFOINCI_e(Information Management of Incidents)_enterprise</strong>
		<p><span style="color: #000000;">
		InfoInci (Information Management of Incidents) is a useful tool to identify key trends buried in large volumes of data, which lets users dedicate the bulk of their time and attention on the most probable cases. Better yet, continuous improvement in incident tracking detection means that businesses are becoming better at minimizing workplace incidents. 
		<strong>May it be noted that InfoInci comes with features those are must for an Indian situation</strong>.  
		</span></p>
		...
		<p>
		<table width="100%" border="1" align="right" cellpadding="0" cellspacing="0" bordercolor="#568F5F" class="schedule_fa">
		<tbody><tr>
		  <td colspan="3" valign="top"><div align="center"><strong class="click_1">DASHBOARD</strong></div></td>
		</tr>
		<tr>
		  <td width="16%" valign="top"><div align="center"><strong>Pending Reports </strong></div></td>
		  <td width="14%" valign="top"><div align="center"><strong>Activity Alerts </strong></div></td>
		...
		<p><strong><span style="color: #CC3300;">
		...
		<ul>
		<li><span style="color: #013953;">"Menu Driven" <strong>Root Cause Analysis</strong>,</span></li>
		<li><span style="color: #013953;">Collection of information; from Near Miss to Catastrophe,</span></li>
		<li><span style="color: #013953;">On failure Escalation mails to seniors</span></li>
		<li><span style="color: #013953;">User friendly organogram.</span></li>
		</ul>
		<p><span style="color: #000000;">
		...
		<ul>
		<li><span style="color: #013953;">First Aid Medical Treatment</span></li>
		<li><span style="color: #013953;">Work Restriction</span></li>
		<li><span style="color: #013953;">Lost Time Accident</span></li>
		<li><span style="color: #013953;">Reportable Injury</span></li>
		<li><span style="color: #013953;">Permanent Disablement Case,</span></li>
		<li><span style="color: #013953;">Fatal</span></li>
		<li><span style="color: #013953;">Dangerous Occurrence.(As per State Factories Rules)</span></li>
		</ul>
		<p><span style="color: #000000;">
		<strong>TREND ANALYSIS</strong> to identify pattern and prevent recurrence. <strong>TOOL</strong> for right conclusions and recommendations.Takes care of statutory compliance..
		</span></p>
		<p><span style="color: #000000;">
		<strong>Other Features-</strong>
		</span></p>
		<ul>
		<li><span style="color: #013953;">Menu Driven Root Cause Analysis On-line filling of information related to range of incidents. 
No chance to miss any deficiency gaps – human failure, system failure, lack of training, behaviour etc. over and above the engg. gaps</span></li>
		<li><span style="color: #013953;">Pre-populated fields as per site related base data.</span></li>
		<li><span style="color: #013953;">Authorized users only can access and edit.</span></li>
		<li><span style="color: #013953;">Standardisation of data as per applicable IS code (Classification of accidents, injuries etc.)</span></li>
		<li><span style="color: #013953;">Carrying out HIRA (Hazard Identification and Risk Assessment) as per OHSAS preferably for near misses.</span></li>
		<li><span style="color: #013953;">Configurable hierarchy across the site/company</span></li>
		<li><span style="color: #013953;">Generation of points for CAPA (Corrective Action and Preventive Action) and monitoring and ensuring the compliance aspect of the same, by emails.</span></li>
		<li><span style="color: #013953;">Choice for approval of investigation, if desired, for selected Incidents, by seniors.</span></li>
		<li><span style="color: #013953;">Reports & Statistics.</span></li>
		<li><span style="color: #013953;">Facility to export Reports & Graphs; in Excel</span></li>
		<li><span style="color: #013953;">History view to show history of previous incidents.</span></li>
		<li><span style="color: #013953;">Facility to upload “Proof document” such as photos, enclosures, etc., in history view.</span></li>
		<li><span style="color: #013953;">Dash board - Shows period based tasks due, compliance status, delays or non-compliances.</span></li>
		</ul>
		<p><strong><span style="color: #CC3300;">
		...
		<li><span style="color: #013953;">Shift-wise Report</span></li>
		<li><span style="color: #013953;">Site-wise Report</span></li>
		<li><span style="color: #013953;">Month-wise Report</span></li>
		<li><span style="color: #013953;">Year- wise Report</span></li>
		<li><span style="color: #013953;">Quarter-wise Report</span></li>
		<li><span style="color: #013953;">Investigations Report</span></li>
		<li><span style="color: #013953;">IS Classification Report</span></li>
		<li><span style="color: #013953;">IS - Location of Injury Report</span></li>
		<li><span style="color: #013953;">IS - Nature of Injury Report</span></li>
		<li><span style="color: #013953;">IS - Type of Accidents Report</span></li>
		<li><span style="color: #013953;">IS - Agency Report</span></li>
		<li><span style="color: #013953;">IS - Unsafe Act Report</span></li>
		<li><span style="color: #013953;">IS - Unsafe Material or Physical Condition Report</span></li>
		<li><span style="color: #013953;">IS - Unsafe Personal Factor Report</span></li>
		<li><span style="color: #013953;">Frequency Severity Rate Report</span></li>
		</ul>
		<p><strong><span style="color: #CC3300;">
		Reports and Analysis
		</span></strong></p>
		<ul>
		<li><span style="color: #013953;">Indication of specific types incident, making it easy for reporting to Statutory Authorities.</span></li>
		<li><span style="color: #013953;">Defined input menu / tabs for all types of incidents. Specific data entry screen for the type of incident.</span></li>
		<li><span style="color: #013953;">Finds details of injured worker easily and fast - Sort by name, date of injury, injury description and site location, is possible.</span></li>
		<li><span style="color: #013953;">Recommendations can be tracked according to role assigned and due date.</span></li>
		</ul>
	</div>
...
<aside style='padding:0 0 0 30px' class="sidebar sidebar-primary widget-area" role="complementary" aria-label="Primary Sidebar" itemscope="" >
	<section>
			...
			class="button" href="images/Infolnci.pdf">Download Brochure</a>
			</li>
			<li style='margin:30px 20px 30px 20px'><img src="images/Infolnci.jpg" width="300"></li>
			...
			<div style="background: linear-gradient(160deg, #0d1117 0%, #161b27 60%, #1a2035 100%); border-radius: 16px; overflow: hidden; box-shadow: 0 20px 60px rgba(0,0,0,0.6), 0 0 0 1px rgba(255,255,255,0.08);">
				<div style="padding: 20px 22px 16px 22px; display: flex; align-items: center; gap: 14px; background: linear-gradient(90deg, rgba(255,0,0,0.08) 0%, transparent 100%); border-bottom: 1px solid rgba(255,255,255,0.07);">
					...
					<div>
						<div style="color: #ffffff; font-weight: 700; font-size: 17px; font-family: 'Inter', sans-serif; letter-spacing: 0.2px; line-height: 1.2;">Watch InfoInci in Action</div>
						<div style="color: #64748b; font-size: 12px; font-family: 'Inter', sans-serif; margin-top: 4px;">Product Demo Video</div>
					</div>
				</div>
				<div style="position:relative; padding-bottom:56.25%; height:0; overflow:hidden;">
					<iframe src="https://www.youtube.com/embed/Q2l1Xsygrkw" style="position:absolute;top:0;left:0;width:100%;height:100%;border:0;" allowfullscreen allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"></iframe>
				</div>
