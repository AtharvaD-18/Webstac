...
<li  id="sticky-menu-item"  class="menu-item menu-item-type-post_type menu-item-object-page menu-item fusion-dropdown-submenu"  ><a href="responsiblecare.php" style="color:#0272A7;text-decoration:none;font-weight:bold;font-size:13px;">Responsible Care</a></li>
					</ul>		</nav>
...
<div class="fusion-separator fusion-full-width-sep sep-single" style="border-color:#020202;margin-top:-1px;">
  ...
  <i class="fa fa-thumbs-up" style="color:#020202;"></i></span></div>
		<a id="clariant"></a>
        <br>
        <img src="images/godrejind.png" height="100" width="100" alt="Clariant" style="color:#FC0"/> <font color="#eeb92a">★★★★★ </font><br>
		</p>
	    <p style="font-size:16px; padding:0 10px 10px 0">R Sanjiva Kumar    
		
		(Site Head , Godrej Industries Limited, Ambernath site)
		<br>
		
	  <p style="font-style:italic;  padding:0 10px 10px 0; font-size:15px">
		" I am pleased to inform you that , Our Ambernath site has undergone the ICC Audit for Responsible Care Logo on 25th, 27th and 28th of January 2022, and the team has faced the Audit with lot of confidence and high spirits. We have every reason to believe that the Auditors were happy with the  implementation and found that major requirements were in place. The outcome expected in a  weeks’ time is also expected to be positive." 
		</p>
		<p style="font-style:italic; font-size:15px; line-height:1.4">
		" I take this opportunity to thank you and your team for enabling us for  implementation of the RC guidelines  in the letter and spirit of the principles . I have to give you and your team the due credit for guiding us in your own unique way  in building understanding and confidence in my team and making this possible. I am grateful to your team for the support given with lot of dedication .

Thanking you once again."</p>
		<br>
<div class="fusion-separator fusion-full-width-sep sep-single" style="border-color:#020202;margin-top:-1px;">
<span class="icon-wrapper" style="border-color:#020202;">
<i class="fa fa-thumbs-up" style="color:#020202;"></i></span></div>
		<a id="farmson"></a>
        <br>
        <img src="images/pp.jpg" height="100" width="100" alt="farmson" style="color:#FC0"/><br>
		</p>
	    <p style="font-size:16px; padding:0 10px 10px 0">Tapan Wagle  <font color="#eeb92a">★★★★★ </font>
          <br>
          
		
	  <p style="font-style:italic;  padding:0 10px 10px 0; font-size:15px">
		" I have subscribed to Webstac Software for more than five years now. It is among the best, if not the best resource for EHS legislation in India, with a very user friendly mode of operation. The commentary, updates, case laws and case studies are all very unique features and very useful for any EHS professional. Apart from this, the advice and / or insights provided by Mr. Bukkawar from time to time as well as support from Mr. Mhatre are very much appreciated. Best wishes to Webstac for continuing the excellent work."</p>
...
<i class="fa fa-thumbs-up" style="color:#020202;"></i></span></div>
		<a id="farmson"></a>
        <br>
        <img src="images/farmsoncompany.png" height="100" width="100" alt="farmson" style="color:#FC0"/><font color="#eeb92a">★★★★★ </font><br>
		</p>
	    <p style="font-size:16px; padding:0 10px 10px 0">Vinit Menon (Chief Executive Officer)
          <br>
          
		
	  <p style="font-style:italic;  padding:0 10px 10px 0; font-size:15px">
		“We are pleased to inform you that Indian chemical council has accorded permission to use Responsible Care Logo for three years to our both company.” 
		“At this occasion, we want to thank you for your time, talent and expertise given, 
		through your active participation in the Responsible Care Logo certification audit process of our group companies. 
		It was your vision and guidance, which helped us to conquer this uphill task. Moreover, your ideas, vision and enthusiasm were most helpful to improve our safety health and environment culture.”.</p>
...
<i class="fa fa-thumbs-up" style="color:#020202;"></i></span></div>
		<a id="rallis"></a>
        <br>
        <img src="images/Rallis_India.jpg" height="100" width="100" alt="Clariant" style="color:#FC0"/><font color="#eeb92a">★★★★★ </font><br>
		</p>
	    <p style="font-size:16px; padding:0 10px 10px 0">Mr. Ravindra Joshi (VP & Head manufacturing);
          <br>
          Mr. Alok chandra (Head HR & Corporate Sustainability)
		<br>
		
	  <p style="font-style:italic;  padding:0 10px 10px 0; font-size:15px">
		"We are happy to share our feedback regarding experience of our team in usage of 3S (Safety Support System) software provided by Webstac.<br>
	  Following are key benefits which we have observed while using the 3S (Safety Support System) software.</p>
	  <ul type="disc">
	    <li><em>It has helped us to move from Excel based monitoring to software based tracking system.</em></li>
	    <li><em>More visibility in compliance monitoring</em></li>
	    <li><em>Escalation facility helped in ensuring compliance within the time limits</em></li>
	    <li><em>Reviewing the compliance status effectively</em></li>
	    <li><em>On the basis of compliance &quot;Unit Head&quot; gives his feedback to &quot;CEO&quot; of the organisation. This has built confidence in ensuring % statutory compliance.</em></li>
	    <li><em>It has also enhanced the awareness among users.</em></li>
	  </ul></p>
	  <em>We highly appreciate such initiative which is really helping us in adhering to one of the important aspect of running our business i.e. &quot;Statutory Compliance Monitoring&quot;.
	  </em>
	  <p><em>We look forware to have continued association with Webstac for the years to come.</em> </p>
	    <br>
      </p>
	  <div class="fusion-separator fusion-full-width-sep sep-single" style="border-color:#020202;margin-top:-1px;">
  <span class="icon-wrapper" style="border-color:#020202;">
  <i class="fa fa-thumbs-up" style="color:#020202;"></i></span></div>
		<a id="clariant"></a>
        <br>
        <img src="images/clariant.png" height="100" width="100" alt="Clariant" style="color:#FC0"/> <font color="#eeb92a">★★★★★ </font><br>
		</p>
	    <p style="font-size:16px; padding:0 10px 10px 0">P.A. Murali     
		
		(Vice President - Regional Sustainability and Regulatory Affairs)
		<br>
		
	  <p style="font-style:italic;  padding:0 10px 10px 0; font-size:15px">
		"Introduction of the 3S (Safety Support System) software has been useful and helped us to move from conventional method to software based tracking system and also to maintain and monitor our compliance records. The inbuilt system to send alerts and features such as escalation matrix and quick review of compliance status are found to be very useful to our line Managers. In addition, 
		we have found this tool to be useful to plan our Meetings, Audits and Inspections where tracking is required." 
		</p>
		<p style="font-style:italic; font-size:15px; line-height:1.4">
		"We do appreciate the efforts taken by Team Webstac for creating this software and wish you all the success."</p>
		<br>
		<div class="fusion-separator fusion-full-width-sep sep-single" style="border-color:#020202;margin-top:-1px;">
<span class="icon-wrapper" style="border-color:#020202;">
<i class="fa fa-thumbs-up" style="color:#020202;"></i></span></div>
		<a id="alkyl"></a>
        <br>
        <img src="images/alkylamines.png" height="100" width="100" alt="Clariant" style="color:#FC0"/> <font color="#eeb92a">★★★★★ </font><br>
		<p style="font-size:16px; padding:0 10px 10px 0">Kirat Patel (Executive Director)
		<br>
		</p>
		<p style="font-style:italic;  padding:0 10px 10px 0; font-size:15px">
		"Alkyl Amines Chemicals Limited has installed, and used the 3S (Safety Support System) Software Package, of Webstac over the last six months to track its statutory obligations and has found the system user friendly at the operating level, useful for Senior Management for monitoring and expandable to include many other time based obligations.
		We are using it, for all our manufacturing sites across India." 
		</p>
		<p style="font-style:italic; font-size:15px; line-height:1.4">
		"We have no hesitation in recommending the system to any other corporate user."</p>
	</div>
